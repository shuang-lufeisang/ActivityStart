...
public class StringUtils {
    ...
    public static String [] returnImageUrlsFromHtml(String contentHtml) {
        ...
        if (imageSrcList == null || imageSrcList.size() == 0) {
            LogUtils.printError("imageSrcList","资讯中未匹配到图片链接");
            return null;
        }
