...
public class MethodsCompat {
    ...
    @TargetApi(7)
    public static Bitmap getThumbnail(ContentResolver cr, long origId, int kind, BitmapFactory.Options options) { // which Options should use in here?
