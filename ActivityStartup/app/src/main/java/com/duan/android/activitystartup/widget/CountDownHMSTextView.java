 ...
 * </pre>
 */
public class CountDownHMSTextView  extends AppCompatTextView implements LifecycleObserver, View.OnClickListener {
    ...
    public CountDownHMSTextView(Context context) {
        this(context, null);
    }

    public CountDownHMSTextView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CountDownHMSTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
     ...
     * @param normalText 文本
     */
    public CountDownHMSTextView setNormalText(String normalText) {
     ...
     */
    public CountDownHMSTextView setCountDownText(String front, String latter) {
     ...
     * @param intervalUnit
     */
    public CountDownHMSTextView setIntervalUnit(TimeUnit intervalUnit) {
    ...
    public CountDownHMSTextView setOnCountDownStartListener(OnCountDownStartListener onCountDownStartListener) {
        mOnCountDownStartListener = onCountDownStartListener;
        return this;
    }

    public CountDownHMSTextView setOnCountDownTickListener(OnCountDownTickListener onCountDownTickListener) {
        mOnCountDownTickListener = onCountDownTickListener;
        return this;
    }

    public CountDownHMSTextView setOnCountDownFinishListener(OnCountDownFinishListener onCountDownFinishListener) {
     ...
     */
    public CountDownHMSTextView setCountDownClickable(boolean clickable) {
     ...
     * @param keep 是否保持
     */
    public CountDownHMSTextView setCloseKeepCountDown(boolean keep) {
     ...
     */
    public CountDownHMSTextView setShowFormatTime(boolean formatTime) {
